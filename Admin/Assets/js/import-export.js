/**
 * Import/Export Tab - AJAX with SweetAlert2
 */
(function($) {
    'use strict';
    ...
    $(document).ready(function() {
        ...
        const exportForm = $('.cbedu-ie-card-export form');
        const importForm = $('.cbedu-ie-card-import form');
        ...
        if (exportForm.length > 0) {
            exportForm.on('submit', handleExport);
        }

        // Import AJAX handler
        if (importForm.length > 0) {
            importForm.on('submit', handleImport);
        }
        ...
        function handleExport(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    nonce: cbeduImportExport.exportNonce
                },
        ...
        function handleImport(e) {
            ...
            formData.append('nonce', cbeduImportExport.importNonce);
