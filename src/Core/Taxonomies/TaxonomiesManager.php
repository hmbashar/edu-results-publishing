...
class TaxonomiesManager
{
    ...
    {
        $this->registerSessionYearsTaxonomy();
        $this->registerExaminationTaxonomy();
        $this->registerBoardTaxonomy();
        $this->registerDepartmentGroupTaxonomy();
    }

    /**
     * Register Session Years taxonomy
     *
     * @return void
     */
    private function registerSessionYearsTaxonomy()
    {
        $labels = array(
        ...
        register_taxonomy(
            $this->prefix . 'session_years',
            array($this->prefix . 'students', $this->prefix . 'results'),
            $args
        );
    }

    /**
     * Register Examination taxonomy
     *
     * @return void
     */
    private function registerExaminationTaxonomy()
    {
        $labels = array(
    ...
    /**
     * Register Board taxonomy
     *
     * @return void
     */
    private function registerBoardTaxonomy()
    {
        $labels = array(
    ...
    /**
     * Register Department/Group taxonomy
     *
     * @return void
     */
    private function registerDepartmentGroupTaxonomy()
    {
        $labels = array(
